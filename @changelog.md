...
- Note: **The three cases do not look the same to the player, and the difference is not explained.** With no time or weather saved, the weather playing at the time carries on and only the lock goes. With a saved weather that is not installed, the sky returns to sunny. Observed in game; the reason one path leaves the weather alone and the other resets it has not been established.
