...
* **Live Readout:** The footer shows the current game time and weather state. A padlock appears when SLM is holding the weather - right-click it to hand the weather back - and it turns red when another mod has taken it.
